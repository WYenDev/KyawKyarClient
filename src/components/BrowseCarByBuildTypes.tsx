            ...
            <div className="relative h-[420px] flex items-center justify-center z-10">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                {buildTypes.map((type, index) => (
                  ...
                  >
                    {/* Card Wrapper */}
                    <div className={`w-full h-[300px] bg-white rounded-none flex flex-col items-center justify-center px-6 pt-6 pb-12 relative overflow-hidden transition-all duration-500 ease-out border border-slate-100 ${index === activeIndex ? 'cursor-pointer' : 'cursor-default opacity-50 grayscale'}`}>
